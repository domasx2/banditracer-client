...
var progfn=gamejs.ready(function(){
...
function loading(){
  if(!canvas){
      canvas=document.getElementById("jsgamecanvas");
      if(canvas){
      ...
      var loading_pt=[display_size[0]/2-loading_img_size[0]/2, display_size[1]/2-loading_img_size[1]/2];
